...
function makeCube(){
	...
	var vcol1 = vec4.fromValues( 0.0, 0.0, 0.0, 0.5 );
	var vcol2 = vec4.fromValues( 0.2, 0.0, 0.0, 0.4 );
	var vcol3 = vec4.fromValues( 0.1, 0.4, 0.0, 1.0 );
	var vcol4 = vec4.fromValues( 0.0, 0.6, 0.0, 0.8 );
	var vcol5 = vec4.fromValues( 0.0, 0.0, 0.4, 0.2 );
	var vcol6 = vec4.fromValues( 0.15, 0.0, 0.3, 0.4 );
	var vcol7 = vec4.fromValues( 0.0, 0.9, 0.2, 0.1 );
	var vcol8 = vec4.fromValues( 1.0, 0.6, 1.0, 1.0 );
