...
/*** Constructor ***/
Medical_Image_Viewer.volume.VoxelValue = Medical_Image_Viewer.volume.VoxelValue || function (imageData, imageType, imageDimensions, imageRange,
                                                                 orientation) {
    ...
    this.swap16 = ((this.imageType.numBytes === 2) && this.imageType.swapped) &&
        (this.imageType.datatype !== Medical_Image_Viewer.volume.ImageType.DATATYPE_FLOAT);
...
Medical_Image_Viewer.volume.VoxelValue.prototype.getVoxelAtIndexNative = function (ctrX, ctrY, ctrZ, timepoint, useNN) {
    if (useNN) {
        ctrX = Medical_Image_ViewerRoundFast(ctrX);
        ctrY = Medical_Image_ViewerRoundFast(ctrY);
        ctrZ = Medical_Image_ViewerRoundFast(ctrZ);
...
Medical_Image_Viewer.volume.VoxelValue.prototype.getVoxelAtIndex = function (ctrX, ctrY, ctrZ, timepoint, useNN) {
    if (useNN) {
        ctrX = Medical_Image_ViewerRoundFast(ctrX);
        ctrY = Medical_Image_ViewerRoundFast(ctrY);
        ctrZ = Medical_Image_ViewerRoundFast(ctrZ);
...
Medical_Image_Viewer.volume.VoxelValue.prototype.getVoxelAtOffset = function (volOffset, timepoint, xLoc, yLoc, zLoc) {
    var dataScaleIndex,
...
Medical_Image_Viewer.volume.VoxelValue.prototype.getVoxelAtIndexLinear = function (xLoc, yLoc, zLoc, timepoint) {
...
Medical_Image_Viewer.volume.VoxelValue.prototype.checkSwap = function (val) {
    /*jslint bitwise: true */
