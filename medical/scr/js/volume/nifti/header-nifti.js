...
Medical_Image_Viewer.volume.nifti = Medical_Image_Viewer.volume.nifti || {};

var xss = xss || ((typeof require !== 'undefined') ? require('xss') : null);

/*** Constructor ***/
Medical_Image_Viewer.volume.nifti.HeaderNIFTI = Medical_Image_Viewer.volume.nifti.HeaderNIFTI || function () {
    this.nifti = null;
    this.isNIFTI2 = false;
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.ORIENTATION_DEFAULT = "XYZ-++";
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.SPATIAL_UNITS_MASK = 0x07;
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.TEMPORAL_UNITS_MASK = 0x38;


/*** Static Methods ***/

Medical_Image_Viewer.volume.nifti.HeaderNIFTI.isThisFormat = function (filename, data) {
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.readHeaderData = function (data, progressMeter, dialogHandler,
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.readImageData = function (progressMeter, onFinishedImageRead) {
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getImageDimensions = function () {
    var id = new Medical_Image_Viewer.volume.ImageDimensions(this.nifti.dims[1], this.nifti.dims[2], this.nifti.dims[3],
        this.nifti.dims[4]);
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getName = function () {
    return null;
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getSeriesLabels = function () {
    var seriesLabels = null;

    if (this.ext) {
        try {
            var xml = Medical_Image_Viewer.utilities.StringUtils.arrayBufferToString(this.ext).replace(/[^\x20-\x7F]/g, "").trim();
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getVoxelDimensions = function () {
    /*jslint bitwise: true */
    var vd;

    vd = new Medical_Image_Viewer.volume.VoxelDimensions(this.nifti.pixDims[1], this.nifti.pixDims[2], this.nifti.pixDims[3],
        this.nifti.pixDims[4]);

    vd.spatialUnit = (this.nifti.xyzt_units & Medical_Image_Viewer.volume.nifti.HeaderNIFTI.SPATIAL_UNITS_MASK);
    vd.temporalUnit = (this.nifti.xyzt_units & Medical_Image_Viewer.volume.nifti.HeaderNIFTI.TEMPORAL_UNITS_MASK);
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getImageType = function () {
    var datatype = Medical_Image_Viewer.volume.ImageType.DATATYPE_UNKNOWN;
    ...
    if ((this.nifti.datatypeCode === nifti.NIFTI1.TYPE_UINT8) ||
        ...
        datatype = Medical_Image_Viewer.volume.ImageType.DATATYPE_INTEGER_UNSIGNED;
        ...
        datatype = Medical_Image_Viewer.volume.ImageType.DATATYPE_INTEGER_SIGNED;
    } else if ((this.nifti.datatypeCode === nifti.NIFTI1.TYPE_FLOAT32) ||
        (this.nifti.datatypeCode === nifti.NIFTI1.TYPE_FLOAT64)) {
        datatype = Medical_Image_Viewer.volume.ImageType.DATATYPE_FLOAT;
    } else if (this.nifti.datatypeCode === nifti.NIFTI1.TYPE_RGB24) {
        datatype = Medical_Image_Viewer.volume.ImageType.DATATYPE_RGB;
    }

    return new Medical_Image_Viewer.volume.ImageType(datatype, this.nifti.numBitsPerVoxel / 8, this.nifti.littleEndian,
        this.compressed);
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getOrientation = function () {
    ...
    if (orientation === null) {
        orientation = Medical_Image_Viewer.volume.nifti.HeaderNIFTI.ORIENTATION_DEFAULT;
    }
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getOrientationQform = function () {
    var orientation = Medical_Image_Viewer.volume.nifti.HeaderNIFTI.ORIENTATION_DEFAULT,
    ...
    if (this.nifti.qform_code > 0) {
        ...
        if (!Medical_Image_Viewer.volume.Orientation.isValidOrientationString(orientation)) {
            orientation = Medical_Image_Viewer.volume.nifti.HeaderNIFTI.ORIENTATION_DEFAULT;
        }
    } else {
        orientation = Medical_Image_Viewer.volume.nifti.HeaderNIFTI.ORIENTATION_DEFAULT;
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getOrientationSform = function () {
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getQformMatCopy = function () {
    return this.nifti.getQformMat().clone();
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getSformMatCopy = function () {
    return this.nifti.affine.clone();
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getOrigin = function (forceQ, forceS) {
    var origin = new Medical_Image_Viewer.core.Coordinate(0, 0, 0),
        qFormMatParams,
        affineQform,
        affineQformInverse,
        affineSformInverse,
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.qFormHasRotations = function () {
    return Medical_Image_Viewer.volume.Transform.hasRotations(this.getQformMatCopy());
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.sFormHasRotations = function () {
    return Medical_Image_Viewer.volume.Transform.hasRotations(this.getSformMatCopy());
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getImageRange = function () {
    var ir = new Medical_Image_Viewer.volume.ImageRange(this.nifti.cal_min, this.nifti.cal_max),
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.hasError = function () {
    return false;
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getImageDescription = function () {
    return new Medical_Image_Viewer.volume.ImageDescription(this.nifti.description);
};



Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getOrientationCertainty = function () {
    var certainty, origin;

    certainty = Medical_Image_Viewer.volume.Header.ORIENTATION_CERTAINTY_UNKNOWN;

    if ((this.nifti.qform_code > 0) || (this.nifti.sform_code > 0)) {
        certainty = Medical_Image_Viewer.volume.Header.ORIENTATION_CERTAINTY_LOW;

        origin = this.getOrigin();
        if ((origin !== null) && !origin.isAllZeros()) {
            certainty = Medical_Image_Viewer.volume.Header.ORIENTATION_CERTAINTY_HIGH;
        }
    }
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getBestTransform = function () {
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.getBestTransformOrigin = function () {
    if ((this.nifti.qform_code > 0) && (this.nifti.qform_code > this.nifti.sform_code) && this.qFormHasRotations()) {
...
Medical_Image_Viewer.volume.nifti.HeaderNIFTI.prototype.toString = function () {
    var fmt = Medical_Image_Viewer.utilities.StringUtils.formatNumber,
        string = "";
    ...
    if (this.isNIFTI2) {
        ...
        string += ("<span style='color:#B5CBD3'>Description</span>: \"" + filterXSS(this.nifti.description) + "\"<br />");
        string += ("<span style='color:#B5CBD3'>Auxiliary File</span>: \"" + filterXSS(this.nifti.aux_file) + "\"<br />");
        ...
        string += ("<span style='color:#B5CBD3'>Intent Name</span>: \"" + filterXSS(this.nifti.intent_name) + "\"<br />");
