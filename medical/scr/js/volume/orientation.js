...
/*** Constructor ***/
Medical_Image_Viewer.volume.Orientation = Medical_Image_Viewer.volume.Orientation || function (str) {
...
Medical_Image_Viewer.volume.Orientation.DEFAULT = "XYZ+--";


/*** Static Methods ***/

Medical_Image_Viewer.volume.Orientation.isValidOrientationString = function (orientationStr) {
    var temp, valid = true;
...
Medical_Image_Viewer.volume.Orientation.prototype.convertIndexToOffsetNative = function (xLoc, yLoc, zLoc) {
    return (xLoc * this.xIncrement) + (yLoc * this.yIncrement) + (zLoc * this.zIncrement);
};



Medical_Image_Viewer.volume.Orientation.prototype.convertIndexToOffset = function (xLoc, yLoc, zLoc) {
    var xLoc2, yLoc2, zLoc2;

    xLoc2 = Medical_Image_ViewerFloorFast((xLoc * this.orientMat[0][0]) + (yLoc * this.orientMat[0][1]) + (zLoc * this.orientMat[0][2]) + (this.orientMat[0][3]));
    yLoc2 = Medical_Image_ViewerFloorFast((xLoc * this.orientMat[1][0]) + (yLoc * this.orientMat[1][1]) + (zLoc * this.orientMat[1][2]) + (this.orientMat[1][3]));
    zLoc2 = Medical_Image_ViewerFloorFast((xLoc * this.orientMat[2][0]) + (yLoc * this.orientMat[2][1]) + (zLoc * this.orientMat[2][2]) + (this.orientMat[2][3]));

    return (xLoc2 * this.xIncrement) + (yLoc2 * this.yIncrement) + (zLoc2 * this.zIncrement);
}


Medical_Image_Viewer.volume.Orientation.prototype.convertCoordinate = function (coord, coordConverted) {
    coordConverted.x = Medical_Image_ViewerRoundFast((coord.x * this.orientMat[0][0]) + (coord.y * this.orientMat[0][1]) +
        (coord.z * this.orientMat[0][2]) + (this.orientMat[0][3]));
    coordConverted.y = Medical_Image_ViewerRoundFast((coord.x * this.orientMat[1][0]) + (coord.y * this.orientMat[1][1]) +
        (coord.z * this.orientMat[1][2]) + (this.orientMat[1][3]));
    coordConverted.z = Medical_Image_ViewerRoundFast((coord.x * this.orientMat[2][0]) + (coord.y * this.orientMat[2][1]) +
...
Medical_Image_Viewer.volume.Orientation.prototype.createInfo = function (imageDimensions, voxelDimensions) {
...
Medical_Image_Viewer.volume.Orientation.prototype.isValid = function () {
    return Medical_Image_Viewer.volume.Orientation.isValidOrientationString(this.orientation);
};



Medical_Image_Viewer.volume.Orientation.prototype.getOrientationDescription = function () {
