...
Medical_Image_Viewer.viewer.Preferences = Medical_Image_Viewer.viewer.Preferences || function () {
    ...
    this.showAnnotation = Medical_Image_Viewer.viewer.Preferences.DEFAULT_SHOW_ANNOTATION;
    this.showCircle = Medical_Image_Viewer.viewer.Preferences.DEFAULT_SHOW_CIRCLE;
...
Medical_Image_Viewer.viewer.Preferences.ALL_PREFS = ["showCrosshairs", "atlasLocks", "showOrientation", "showCircle", "scrollBehavior",
    "smoothDisplay", "radiological", "showRuler", "showAnnotation", "surfaceBackgroundColor", "showSurfacePlanes"];
...
Medical_Image_Viewer.viewer.Preferences.DEFAULT_SHOW_CIRCLE = "No";
Medical_Image_Viewer.viewer.Preferences.DEFAULT_SHOW_ANNOTATION = "No";
