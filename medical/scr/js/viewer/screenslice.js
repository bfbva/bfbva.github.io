...
Medical_Image_Viewer.viewer.ScreenSlice = Medical_Image_Viewer.viewer.ScreenSlice || function (vol, dir, width, height, widthSize, heightSize,
        ...
        this.circlePoints = [new Medical_Image_Viewer.core.Point(parseInt(width * 0.25), parseInt(height * 0.25)),
            new Medical_Image_Viewer.core.Point(parseInt(width * 0.75), parseInt(height * 0.75))];
...
Medical_Image_Viewer.viewer.ScreenSlice.prototype.findProximalCircleHandle = function (xLoc, yLoc) {
    this.tempPoint.x = xLoc;
    this.tempPoint.y = yLoc;

    if (Medical_Image_Viewer.utilities.MathUtils.lineDistance(this.tempPoint.x, this.tempPoint.y, this.circlePoints[0].x, this.circlePoints[0].y) < Medical_Image_Viewer.viewer.ScreenSlice.GRAB_RADIUS) {
        return this.circlePoints[0];
    } else if (Medical_Image_Viewer.utilities.MathUtils.lineDistance(this.tempPoint.x, this.tempPoint.y, this.circlePoints[1].x, this.circlePoints[1].y) < Medical_Image_Viewer.viewer.ScreenSlice.GRAB_RADIUS) {
        return this.circlePoints[1];
    }
