...
var shaderVert = [
    ...
    "    if (!uActivePlane && !uActivePlaneEdge && !uCrosshairs && !uOrientationText && !uRuler && !uCircle) {",
...
Medical_Image_Viewer.viewer.ScreenSurface = Medical_Image_Viewer.viewer.ScreenSurface || function (baseVolume, surfaces, viewer, params) {
    ...
    this.zoom = 0;
    this.sliceDirection = Medical_Image_Viewer.viewer.ScreenSlice.DIRECTION_SURFACE;
    ...
    this.backgroundColor = Medical_Image_Viewer.viewer.ScreenSurface.DEFAULT_BACKGROUND;
    this.pickLocX = 0;
    this.pickLocY = 0;
...
Medical_Image_Viewer.viewer.ScreenSurface.DEFAULT_ORIENTATION = [ -0.015552218963737041, 0.09408106275544359, -0.9954430697501158, 0,
                                                    -0.9696501263313991, 0.24152923619118966, 0.03797658948646743, 0,
                                                    0.24400145970103732, 0.965822108594413, 0.0874693978960848, 0,
                                                    0, 0, 0, 1];
Medical_Image_Viewer.viewer.ScreenSurface.MOUSE_SENSITIVITY = 0.3;
Medical_Image_Viewer.viewer.ScreenSurface.DEFAULT_BACKGROUND = [0.5, 0.5, 0.5];
Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE = 50;
Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE = 10;
Medical_Image_Viewer.viewer.ScreenSurface.RULER_COLOR = [1, 0.078, 0.576];
Medical_Image_Viewer.viewer.ScreenSurface.RULER_NUM_LINES = 25;
Medical_Image_Viewer.viewer.ScreenSurface.RULER_RADIUS = 1;
Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_COLOR = [1, 0.078, 0.576];
Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_NUM_LINES = 25;
Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_RADIUS = 1;

/*** Static Variables ***/

Medical_Image_Viewer.viewer.ScreenSurface.EXT_INT = null;



/*** Static Methods ***/

Medical_Image_Viewer.viewer.ScreenSurface.makeShader = function (gl, src, type) {
...
Medical_Image_Viewer.viewer.ScreenSurface.initShaders = function (gl) {
    var fragmentShader = Medical_Image_Viewer.viewer.ScreenSurface.makeShader(gl, shaderVert, gl.VERTEX_SHADER);
    var vertexShader = Medical_Image_Viewer.viewer.ScreenSurface.makeShader(gl, shaderFrag, gl.FRAGMENT_SHADER);
    ...
    shaderProgram.circle = gl.getUniformLocation(shaderProgram, "uCircle");
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.initialize = function () {
    var ctr;
    ...
    this.shaderProgram = Medical_Image_Viewer.viewer.ScreenSurface.initShaders(this.context);
    ...
    this.initCircleBuffers(this.context);

    mat4.multiply(this.centerMat, Medical_Image_Viewer.viewer.ScreenSurface.DEFAULT_ORIENTATION, this.tempMat);
    mat4.multiply(this.tempMat, this.centerMatInv, this.mouseRotCurrent);

    Medical_Image_Viewer.viewer.ScreenSurface.EXT_INT = this.context.getExtension('OES_element_index_uint');
    if (!Medical_Image_Viewer.viewer.ScreenSurface.EXT_INT) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.calculateScaleFactor = function () {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.resize = function (screenDim) {
    if (!this.initialized) {
        this.initialize();
    }
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.applyMatrixUniforms = function(gl) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.draw = function () {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.initBuffers = function (gl, surface) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.initOrientationBuffers = function (gl) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.initActivePlaneBuffers = function (gl) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.initRulerBuffers = function (gl) {
    this.rulerPointData = this.makeSphere(Medical_Image_Viewer.viewer.ScreenSurface.RULER_NUM_LINES,
        Medical_Image_Viewer.viewer.ScreenSurface.RULER_NUM_LINES, Medical_Image_Viewer.viewer.ScreenSurface.RULER_RADIUS * this.scaleFactor);
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.initCircleBuffers = function (gl) {
    this.circlePointData = this.makeSphere(Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_NUM_LINES,
        Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_NUM_LINES, Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_RADIUS * this.scaleFactor);

    this.sphereVertexPositionBuffer = gl.createBuffer();
    this.sphereVertexPositionBuffer.itemSize = 3;
    this.sphereVertexPositionBuffer.numItems = this.circlePointData.vertices.length / 3;

    this.sphereNormalsPositionBuffer = gl.createBuffer();
    this.sphereNormalsPositionBuffer.itemSize = 3;
    this.sphereNormalsPositionBuffer.numItems = this.circlePointData.normals.length / 3;

    this.sphereVertexIndexBuffer = gl.createBuffer();
    this.sphereVertexIndexBuffer.itemSize = 1;
    this.sphereVertexIndexBuffer.numItems = this.circlePointData.indices.length;

    this.circleLineBuffer = gl.createBuffer();
    this.circleLineBuffer.itemSize = 3;
    this.circleLineBuffer.numItems = 2;
};

Medical_Image_Viewer.viewer.ScreenSurface.prototype.initPerspective = function () {
    ...
    this.centerWorld = new Medical_Image_Viewer.core.Coordinate();
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.updatePerspective = function () {
    var mat;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.unpackFloatFromVec4i = function (val) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.hasTranslucentSurfaces = function () {
    var ctr;
    for (ctr = 0; ctr < this.surfaces.length; ctr += 1) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.drawScene = function (gl) {
    ...
    if (this.needsPick) {
        ...
        if ((this.viewer.mainImage === this.viewer.surfaceView) &&
            ...
            this.drawOrientedText(gl, "S", Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE, [(xSlice * this.xSize) - this.xHalf, (ySlice * this.ySize) - this.yHalf,
                this.zHalf + Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE * this.scaleFactor - ((this.zDim / 2) -
                this.volume.header.origin.z) * this.zSize]);
            this.drawOrientedText(gl, "I", Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE,[(xSlice * this.xSize) - this.xHalf, (ySlice * this.ySize) - this.yHalf,
                -this.zHalf - Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE * this.scaleFactor - ((this.zDim / 2) -
                this.volume.header.origin.z) * this.zSize]);
            this.drawOrientedText(gl, "P", Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE, [(xSlice * this.xSize) - this.xHalf, -this.yHalf -
            Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE * this.scaleFactor - ((this.yDim / 2) -
            this.volume.header.origin.y) * this.ySize, (zSlice * this.zSize) - this.zHalf]);
            this.drawOrientedText(gl, "A", Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE, [(xSlice * this.xSize) - this.xHalf, this.yHalf +
            Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE * this.scaleFactor - ((this.yDim / 2) -
            this.volume.header.origin.y) * this.ySize, (zSlice * this.zSize) - this.zHalf]);
            this.drawOrientedText(gl, "L", Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE, [-this.xHalf - Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE *
            ...
            this.drawOrientedText(gl, "R", Medical_Image_Viewer.viewer.ScreenSurface.TEXT_SIZE, [this.xHalf + Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE *
            this.scaleFactor + ((this.xDim / 2) - this.volume.header.origin.x) * this.xSize,
                (ySlice * this.ySize) - this.yHalf, (zSlice * this.zSize) - this.zHalf]);
        }

        
        /*if (this.viewer.container.preferences.showAnnotation === "Yes") {
            this.drawAnnotation();
        }*/
        ...
        if (this.viewer.container.preferences.showCircle === "Yes") {
            if (this.isMainView()) {
                this.drawCircle(gl);
            }
        } else {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.renderSurface = function (gl, index, isTranslucent, translucentFirstPass, translucentSecondPass) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.drawRuler = function (gl) {
    var found = true;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.drawRulerPoint = function (gl, xLoc, yLoc, zLoc) {
    this.sphereVertexPositionBuffer.numItems = this.rulerPointData.vertices.length / 3;
    ...
    gl.uniform1i(this.shaderProgram.hasSolidColor, 1);
    gl.uniform4f(this.shaderProgram.solidColor, Medical_Image_Viewer.viewer.ScreenSurface.RULER_COLOR[0],
        Medical_Image_Viewer.viewer.ScreenSurface.RULER_COLOR[1], Medical_Image_Viewer.viewer.ScreenSurface.RULER_COLOR[2], 1.0);
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.drawCircle = function (gl) {
    var found = true;

    if (this.circlePoints === null) {
        this.circlePoints = new Float32Array(6);
        found = this.findInitialCirclePoints(gl);
        this.drawScene(gl);  // need to redraw since pick
    }

    if (found) {
        gl.uniform1i(this.shaderProgram.circle, 1);

        // draw endpoints
        this.drawCirclePoint(gl, this.circlePoints[0], this.circlePoints[1], this.circlePoints[2]);
        this.drawCirclePoint(gl, this.circlePoints[3], this.circlePoints[4], this.circlePoints[5]);

        // draw line
        gl.bindBuffer(gl.ARRAY_BUFFER, this.circleLineBuffer);
        gl.bufferData(gl.ARRAY_BUFFER, this.circlePoints, gl.DYNAMIC_DRAW);

        gl.bindBuffer(gl.ARRAY_BUFFER, this.circleLineBuffer);
        gl.vertexAttribPointer(this.shaderProgram.vertexPositionAttribute, this.circleLineBuffer.itemSize, gl.FLOAT,
            false, 0, 0);
        gl.drawArrays(gl.LINES, 0, 2);
        gl.uniform1i(this.shaderProgram.circle, 0);
    }
};



Medical_Image_Viewer.viewer.ScreenSurface.prototype.drawCirclePoint = function (gl, xLoc, yLoc, zLoc) {
    this.sphereVertexPositionBuffer.numItems = this.circlePointData.vertices.length / 3;
    gl.bindBuffer(gl.ARRAY_BUFFER, this.sphereVertexPositionBuffer);
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.circlePointData.vertices), gl.STATIC_DRAW);

    this.sphereNormalsPositionBuffer.numItems = this.circlePointData.normals.length / 3;
    gl.bindBuffer(gl.ARRAY_BUFFER, this.sphereNormalsPositionBuffer);
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.circlePointData.normals), gl.STATIC_DRAW);

    this.sphereVertexIndexBuffer.numItems = this.circlePointData.indices.length;
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, this.sphereVertexIndexBuffer);
    gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(this.circlePointData.indices), gl.STATIC_DRAW);

    gl.uniform1i(this.shaderProgram.hasSolidColor, 1);
    gl.uniform4f(this.shaderProgram.solidColor, Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_COLOR[0],
        Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_COLOR[1], Medical_Image_Viewer.viewer.ScreenSurface.CIRCLE_COLOR[2], 1.0);
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.drawOrientedText = function (gl, str, fontSize, coord) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.bindOrientation = function (gl) {
    gl.bindBuffer(gl.ARRAY_BUFFER, this.orientationBuffer);
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.bindActivePlanes = function (gl) {
    gl.bindBuffer(gl.ARRAY_BUFFER, this.activePlaneAxialBuffer);
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.clearDTILinesImage = function () {
    // just here to satisfy interface
};



Medical_Image_Viewer.viewer.ScreenSurface.prototype.findProximalRulerHandle = function (xLoc, yLoc) {
    this.pick(xLoc, yLoc, true);
    this.grabbedRulerPoint = -1;

    if (this.pickedCoordinate && this.rulerPoints) {
        if (Medical_Image_Viewer.utilities.MathUtils.lineDistance3d(this.rulerPoints[0], this.rulerPoints[1],
                ...
                (Medical_Image_Viewer.viewer.ScreenSlice.GRAB_RADIUS * this.scaleFactor)) {
            this.grabbedRulerPoint = 0;
        } else if (Medical_Image_Viewer.utilities.MathUtils.lineDistance3d(this.rulerPoints[3], this.rulerPoints[4],
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.findProximalCircleHandle = function (xLoc, yLoc) {
    this.pick(xLoc, yLoc, true);
    this.grabbedCirclePoint = -1;

    if (this.pickedCoordinate && this.circlePoints) {
        if (Medical_Image_Viewer.utilities.MathUtils.lineDistance3d(this.circlePoints[0], this.circlePoints[1],
                this.circlePoints[2], this.pickedCoordinate.coordinate[0], this.pickedCoordinate.coordinate[1], this.pickedCoordinate.coordinate[2]) <
                (Medical_Image_Viewer.viewer.ScreenSlice.GRAB_RADIUS * this.scaleFactor)) {
            this.grabbedCirclePoint = 0;
        } else if (Medical_Image_Viewer.utilities.MathUtils.lineDistance3d(this.circlePoints[3], this.circlePoints[4],
                this.circlePoints[5], this.pickedCoordinate.coordinate[0], this.pickedCoordinate.coordinate[1], this.pickedCoordinate.coordinate[2]) <
                (Medical_Image_Viewer.viewer.ScreenSlice.GRAB_RADIUS * this.scaleFactor)) {
            this.grabbedCirclePoint = 1;
        }
    }

    return (this.grabbedCirclePoint !== -1);
};

Medical_Image_Viewer.viewer.ScreenSurface.prototype.setStartDynamic = function (xLoc, yLoc) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.updateDynamic = function (xLoc, yLoc, factor) {
    var rotX = (yLoc - this.dynamicStartY) * Medical_Image_Viewer.viewer.ScreenSurface.MOUSE_SENSITIVITY * factor;
    var rotY = (xLoc - this.dynamicStartX) * Medical_Image_Viewer.viewer.ScreenSurface.MOUSE_SENSITIVITY * factor;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.updateTranslateDynamic = function (xLoc, yLoc, factor) {
    var transX = (xLoc - this.dynamicStartX) * Medical_Image_Viewer.viewer.ScreenSurface.MOUSE_SENSITIVITY * factor;
    var transY = (yLoc - this.dynamicStartY) * Medical_Image_Viewer.viewer.ScreenSurface.MOUSE_SENSITIVITY * factor * -1;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.updateCurrent = function () {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.clearTransform = function (xform) {
    mat4.identity(xform);
    return xform;
};
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.makeOrientedTextSquare = function () {
    var half = Medical_Image_Viewer.viewer.ScreenSurface.ORIENTATION_SIZE * this.scaleFactor;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.updateOrientedTextSquare = function (fontSize, text) {
    ...
    this.orientationCanvas.width = Medical_Image_Viewer.utilities.MathUtils.getPowerOfTwo(textSize);
    this.orientationCanvas.height = Medical_Image_Viewer.utilities.MathUtils.getPowerOfTwo(textSize);
};



Medical_Image_Viewer.viewer.ScreenSurface.prototype.updateActivePlanes = function () {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.pick = function (xLoc, yLoc, skipRedraw) {
    this.needsPick = true;
    this.pickLocX = xLoc;
    this.pickLocY = yLoc;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.pickRuler = function (xLoc, yLoc) {
    this.needsPick = true;
    this.pickLocX = xLoc;
    this.pickLocY = yLoc;
    this.draw(); // do picking
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.pickCircle = function (xLoc, yLoc) {
    this.needsPick = true;
    this.pickLocX = xLoc;
    this.pickLocY = yLoc;
    this.draw(); // do picking
    ...
    if (this.pickedCoordinate) {
        this.circlePoints[(this.grabbedCirclePoint * 3)] = this.pickedCoordinate.coordinate[0];
        this.circlePoints[(this.grabbedCirclePoint * 3) + 1] = this.pickedCoordinate.coordinate[1];
        this.circlePoints[(this.grabbedCirclePoint * 3) + 2] = this.pickedCoordinate.coordinate[2];
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.pickColor = function (xLoc, yLoc) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.findPickedCoordinate = function (gl, xLoc, yLoc) {
    var winX = xLoc,
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.findInitialRulerPoints = function (gl) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.findInitialCirclePoints = function (gl) {
    var xDim = gl.viewportWidth,
        yDim = gl.viewportHeight,
        coord, points = [], finalPoints = [], xLoc, yLoc, ctr, index;
    ...
    this.circlePoints[0] = finalPoints[0][0];
    this.circlePoints[1] = finalPoints[0][1];
    this.circlePoints[2] = finalPoints[0][2];
    this.circlePoints[3] = finalPoints[1][0];
    this.circlePoints[4] = finalPoints[1][1];
    this.circlePoints[5] = finalPoints[1][2];

    return true;
};

Medical_Image_Viewer.viewer.ScreenSurface.prototype.findPickedColor = function (gl) {
    var index;
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.getBackgroundColor = function () {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.updatePreferences = function () {
    this.updateBackgroundColor();
};



Medical_Image_Viewer.viewer.ScreenSurface.prototype.updateBackgroundColor = function () {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.isMainView = function () {
    return (this.viewer.mainImage === this.viewer.surfaceView);
};



Medical_Image_Viewer.viewer.ScreenSurface.prototype.processParams = function (params) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.makeSphere = function (latitudeBands, longitudeBands, radius) {
...
Medical_Image_Viewer.viewer.ScreenSurface.prototype.getRulerLength = function () {
    return Medical_Image_Viewer.utilities.MathUtils.lineDistance3d(this.rulerPoints[0], this.rulerPoints[1],
        this.rulerPoints[2], this.rulerPoints[3], this.rulerPoints[4], this.rulerPoints[5]);
};
Medical_Image_Viewer.viewer.ScreenSurface.prototype.getCircleLength = function () {
    return Medical_Image_Viewer.utilities.MathUtils.lineDistance3d(this.circlePoints[0], this.circlePoints[1],
        this.circlePoints[2], this.circlePoints[3], this.circlePoints[4], this.circlePoints[5]);
};