...
/*** Constructor ***/
Medical_Image_Viewer.viewer.ScreenVolume = Medical_Image_Viewer.viewer.ScreenVolume || function (vol, params, lutName, baseImage, parametric,
                                                                     currentCoord) {
    /*jslint sub: true */
    this.volume = vol;
    this.lutName = lutName;
    this.colorTable = new Medical_Image_Viewer.viewer.ColorTable(this.lutName, baseImage);
    ...
    this.rgb = (this.volume.header.imageType.datatype === Medical_Image_Viewer.volume.ImageType.DATATYPE_RGB);
    ...
    this.canvasIcon.width = Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE;
    this.canvasIcon.height = Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE;
    this.contextIcon = this.canvasIcon.getContext("2d");
    this.imageDataIcon = this.contextIcon.createImageData(Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE,
        Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE);
    this.icon = null;

    this.canvasBar = document.createElement("canvas");
    this.canvasBar.width = Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_WIDTH;
    this.canvasBar.height = Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_HEIGHT;
    this.contextBar = this.canvasBar.getContext("2d");
    this.imageDataBar = this.contextBar.createImageData(Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_WIDTH,
        Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_HEIGHT);
    this.colorBar = null;
...
Medical_Image_Viewer.viewer.ScreenVolume.makeSolidIcon = function (r, g, b) {
    var canvasIcon = document.createElement("canvas");
    canvasIcon.width = Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE;
    canvasIcon.height = Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE;
    var ctx = canvasIcon.getContext("2d");
    ctx.fillStyle = "rgb(" + parseInt(r * 255, 10) + "," + parseInt(g * 255, 10) + "," + parseInt(b * 255, 10) + ")";
    ctx.fillRect(0, 0, Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE, Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE);
    return canvasIcon.toDataURL();
};


Medical_Image_Viewer.viewer.ScreenVolume.makeStaticIcon = function (url, cb, index) {
    var imageObj = new Image(Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE, Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE);
    ...
    imageObj.onload = function() {
        ctx.drawImage(imageObj, 0, 0, imageObj.naturalWidth, imageObj.naturalHeight, 0,0,
            Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE, Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE);
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.setScreenRange = function (min, max) {
    this.screenMin = min;
    this.screenMax = max;
    this.updateScreenRange();
};
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.resetScreenRange = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.setScreenRangeNegatives = function (min, max) {
    this.negativeScreenVol.setScreenRange(min, max);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateScreenRange = function () {
    this.screenRatio = (Medical_Image_Viewer.viewer.ScreenSlice.SCREEN_PIXEL_MAX / (this.screenMax - this.screenMin));
    this.negative = (this.screenMax < this.screenMin);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.isOverlay = function () {
    return !this.colorTable.isBaseImage;
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.findImageRange = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.findDisplayRange = function (parametric, screenParams) {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.isUsingColorTable = function (lutName) {
    return (this.lutName === lutName);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.isRotatingAbout = function (rotationAbout) {
    return (this.rotationAbout === rotationAbout);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.changeColorTable = function (viewer, lutName) {
    this.colorTable = new Medical_Image_Viewer.viewer.ColorTable(lutName, !this.isOverlay());
    this.lutName = lutName;
    this.updateIcon();
    this.updateColorBar();
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.getRange = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.getRangeNegative = function () {
    return this.negativeScreenVol.getRange();
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.getAlphaNegative = function () {
    return this.negativeScreenVol.alpha;
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.incrementTimepoint = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.decrementTimepoint = function () {
    this.currentTimepoint -= 1;
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.setTimepoint = function (timepoint) {
    if (timepoint < 0) {
        this.currentTimepoint = 0;
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateMinLUT = function (minLUTnew) {
    this.colorTable.updateMinLUT(minLUTnew);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateMaxLUT = function (maxLUTnew) {
    this.colorTable.updateMaxLUT(maxLUTnew);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateLUT = function (minLUTnew, maxLUTnew) {
    this.colorTable.updateLUT(minLUTnew, maxLUTnew);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.supportsDynamicColorTable = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.resetDynamicRange = function () {
    this.colorTable.minLUT = 0;
    this.colorTable.maxLUT = Medical_Image_Viewer.viewer.ColorTable.LUT_MAX;
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.getCurrentTime = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.setCurrentTime = function (seconds) {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.hasError = function () {
    return (this.error !== null);
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.initDTI = function () {
    this.volume.numTimepoints = 1;
    this.volume.header.imageDimensions.timepoints = 1;
    this.colorTable = new Medical_Image_Viewer.viewer.ColorTable(this.lutName, false, Medical_Image_Viewer.viewer.ColorTable.TABLE_DTI_SPECTRUM);
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.isDTILines = function () {
    return this.dtiLines && !this.dtiColors;
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.isDTIRGB = function () {
    return !this.dtiLines && this.dtiColors;
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.isDTILinesAndRGB = function () {
    return this.dtiLines && this.dtiColors;
};



Medical_Image_Viewer.viewer.ScreenVolume.prototype.getHiddenLabel = function () {
    if (this.hidden) {
        return "Show Overlay";
    } else {
        return "Hide Overlay";
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateIcon = function () {
    ...
    if (this.staticIcon) {
        ...
        Medical_Image_Viewer.viewer.ScreenVolume.makeStaticIcon(this.staticIcon, updateStaticIcon);
    } else if (this.imageDataIcon) {
        step = Medical_Image_Viewer.viewer.ColorTable.LUT_MAX / Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE;

        for (ctrY = 0; ctrY < Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE; ctrY += 1) {
            for (ctrX = 0; ctrX < Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE; ctrX += 1) {
                index = ((ctrY * Medical_Image_Viewer.viewer.ColorTable.ICON_SIZE) + ctrX) * 4;
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateColorBar = function () {
    var step, ctrY, ctrX, index, value;

    if (this.imageDataBar) {
        step = Medical_Image_Viewer.viewer.ColorTable.LUT_MAX / Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_WIDTH;

        for (ctrY = 0; ctrY < Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_HEIGHT; ctrY += 1) {
            for (ctrX = 0; ctrX < Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_WIDTH; ctrX += 1) {
                index = ((ctrY * Medical_Image_Viewer.viewer.ColorTable.COLOR_BAR_WIDTH) + ctrX) * 4;
                value = Math.round(ctrX * step);
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.updateTransform = function () {
...
Medical_Image_Viewer.viewer.ScreenVolume.prototype.resetTransform = function () {
    this.rotationX = 0.5;
    this.rotationY = 0.5;
    this.rotationZ = 0.5;
};
